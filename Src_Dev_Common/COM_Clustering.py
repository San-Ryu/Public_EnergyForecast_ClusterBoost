...
## 2024-07-24 Dunn Index 부분 추가  
## 2024-07-30 Import 부분 간략화  
## 2024-08-05 Code 개선 및 Error Fix  
...
def get_clustring_score (km, df_X_std, df_y):
    ...
    ## Dunn Index
    score_dunn = get_Dunn_index(df_X_std, labels)
    ## Davies_bouldin 스코어
    ...
    list_scores = [score_sil, score_CHI, score_dunn, score_dbs
    ...
    print("Dunn Index : %0.4f"% score_dunn)
